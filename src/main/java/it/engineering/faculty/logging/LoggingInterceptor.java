...
public class LoggingInterceptor {
    ...
    @Before(value = "@annotation(it.engineering.faculty.logging.Loggable)")
    ...
    @AfterReturning(value = "@annotation(it.engineering.faculty.logging.Loggable)", returning = "returnValue")
    ...
    @AfterThrowing(pointcut = "@annotation(it.engineering.faculty.logging.Loggable)", throwing = "ex")
